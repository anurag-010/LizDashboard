  ...
  const onConnectEnd = useCallback(
    (event) => {
      ...
      if (node) {
        ...
        console.log(
          `add new node with parent node  ${connectingNodeId.current}`
        );
  ...
  return (
    ...
    >
      ...
      <Panel position="top-right" className="react-flow__panel-save-restore">
        ...
        <button className="panel-save-restore__save-btn" onClick={handleSave}>
          Save
        </button>
        <button
          className="panel-save-restore__restore-btn"
